...
\newcommand{\titulo}{Proyecto Acústico de Auditorio}
\newcommand{\titulolargo}{Acondicionamiento acústico interior de una sala para conferencias}
\newcommand{\materia}{Acústica - 66.67 / 86.57}
\newcommand{\fiuba}{Facultad de Ingeniería - UBA}
\newcommand{\cuatrimestre}{2\sptext{do} cuat. 2019} %\sptext{do} $2^{do}$


\newcommand{\autorA}{\textsc{de Aguirre} María del Rocío}
\newcommand{\padronA}{98734}
\newcommand{\mailA}{\weblink{mailto:rocio.de.aguirre@gmail.com}{rocio.de.aguirre@gmail.com}} 
...
\newcommand{\docenteA}{Ing. \textsc{Vechiatti} Nilda.}
\newcommand{\docenteB}{Dr. Ing. \textsc{Gomez} Pablo}



\newcommand{\thedate}{19 de Noviembre de 2019}
